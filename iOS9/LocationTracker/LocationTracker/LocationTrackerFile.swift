...
public class LocationTrackerFile:NSObject, CLLocationManagerDelegate {
    ...
    private var host = "tracking.tookan.io"
    private var portNumber:UInt16 = 1883
    private var slotTime = 5.0
    private var maxSpeed:Float = 30.0
    private var maxAccuracy = 20.0
    private var maxDistance = 20.0
    ...
    public func startLocationTracking() -> (Bool, String) {
    ...
    private func isAllPermissionAuthorized() -> (Bool, String) {
    ...
    private func isAuthorizedUser() -> (Bool,String) {
        let params = ["u_socket_id":uniqueKey,
                      ...
                      "device_details":["device_type":"1",
                                        ...
                                        "imei":"",
                                        "os":(UIDevice.currentDevice().systemVersion as NSString).doubleValue,
                                        "manufacturer":"Apple",
